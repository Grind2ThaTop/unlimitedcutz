...
const BarberLogin = () => {
  ...
  const { accountType, isLoading: accountLoading } = useAccountRole();
  ...
  useEffect(() => {
    if (user && !accountLoading) {
      if (accountType === 'barber') {
        ...
        // Not a barber, redirect to client portal
        toast({
          title: "Not a barber account",
          description: "This login is for barbers only. Redirecting to member portal.",
          variant: "destructive",
        });
        navigate('/portal');
      }
    }
  }, [user, accountType, accountLoading, navigate, toast]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        toast({
          title: "Welcome back!",
          description: "Checking your barber status...",
        });
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-secondary via-secondary to-primary/20 p-12 flex-col justify-between">
        ...
        <div className="relative">
          ...
          <p className="text-secondary-foreground/70 text-lg max-w-md">
            Access your barber dashboard to track cuts, earnings, and enrolled members.
          </p>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-secondary-foreground/40 mt-2">
              New barber? <Link to="/barber/signup" className="text-primary hover:underline">Create an account</Link>
            </p>
          </div>
